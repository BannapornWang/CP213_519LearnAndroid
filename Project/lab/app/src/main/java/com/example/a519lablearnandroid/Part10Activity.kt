...
fun HowToUseCard() {
    OutlinedCard(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text(
                text = "✅ อัปเดต: Widget ลงทะเบียนสำเร็จแล้ว!",
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.primary
            )
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = "วิธีทดสอบ Widget จริง:\n" +
                        "1. กลับไปที่หน้า Home Screen ของมือถือ\n" +
                        "2. กดค้างที่พื้นที่ว่างบนหน้าจอ\n" +
                        "3. เลือกเมนู 'Widgets'\n" +
                        "4. ค้นหาแอป '519LabLearnAndroid'\n" +
                        "5. จะพบ 'My Glance Widget' ให้ลากออกมาวางได้เลย!",
